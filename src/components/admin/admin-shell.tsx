...
export const ADMIN_NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { to: "/admin/console/operations", label: "Operations", icon: Activity },
    ],
  },
  {
    label: "Marketplace",
    items: [
      ...
      { to: "/admin/console/services", label: "Services", icon: Tag },
      { to: "/admin/console/locations", label: "Locations", icon: MapPin },
    ],
  },
  {
    label: "Revenue",
    items: [
      { to: "/admin/console/finance", label: "Finance", icon: Wallet },
      { to: "/admin/console/reviews", label: "Reviews", icon: Star },
      { to: "/admin/console/support", label: "Support", icon: Inbox },
    ],
  },
  {
    label: "Growth",
    items: [
      { to: "/admin/console/marketing", label: "Marketing", icon: Megaphone },
      { to: "/admin/console/content", label: "Content", icon: FileText },
  ...
  },
  {
    label: "Platform",
    items: [
      { to: "/admin/console/team", label: "Team & Roles", icon: ShieldCheck },
      { to: "/admin/console/appearance", label: "Appearance", icon: Palette },
      { to: "/admin/console/settings", label: "Settings", icon: Settings },
      { to: "/admin/console/security", label: "Security", icon: Lock },
    ],
  },
];
