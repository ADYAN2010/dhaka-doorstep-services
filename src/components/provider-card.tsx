...
import { BadgeCheck, Star, MapPin, Clock, ArrowRight } from "lucide-react";
...
export function ProviderCard({ provider }: { provider: Provider }) {
  ...
  return (
    <article className="group flex flex-col gap-4 rounded-2xl border border-border bg-card p-5 transition-all hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-elevated">
